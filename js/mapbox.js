angular.module('staticMapMaker').controller('MapboxController', function($scope) {
  ...
  vm.mapboxids = [
    ...
    { 'value': 'mapbox/streets-v9', 'text' : 'Streets', 'type': 'vector' },
    { 'value': 'mapbox/light-v9', 'text' : 'Light', 'type': 'vector' },
    { 'value': 'mapbox/dark-v9', 'text' : 'Dark', 'type': 'vector' },
    { 'value': 'mapbox/satellite-v9', 'text' : 'Satellite', 'type': 'vector' },
    { 'value': 'mapbox/satellite-streets-v9', 'text' : 'Satellite streets', 'type': 'vector' },
    { 'value': 'mapbox/outdoors-v9', 'text' : 'Outdoors', 'type': 'vector' },
    { 'value': 'mapbox/traffic-day-v2', 'text' : 'Traffic day', 'type': 'vector' },
    { 'value': 'mapbox/traffic-night-v2', 'text' : 'Traffic night', 'type': 'vector' }
  ];
